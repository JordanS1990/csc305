...
bool Program::link()
{
    ...
    // creates an empty program object and returns its reference
    ...
    for(size_t i = 0; i < mShaders.size(); ++i)
    {
        ...
        //Attaches shader to mHandle program
        glError = glGetError();
    ...
    for(int i = 0; i < numUniforms; ++i)
    {
        ...
        // Gets active uniform variable for mHandle
...
void Program::activate()
{
    ...
    //Installs mHandle as part of current rendering state
}
